...
class replyAdaptermainssubjective (private val context: Context, private var List:List<Replymainssubjectivemains>) : RecyclerView.Adapter<replyAdaptermainssubjective.MyHolder>() {
    companion object{
        var size:Int=0
    }
